...
- `retrieveLastThoughtSignature()`: Get the latest opaque Gemini thought signature. GenAIApp automatically echoes a function call's signature on its function-result continuation.
