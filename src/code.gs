...
const GenAIApp = (function () {
  ...
  class Chat {
    constructor() {
       ...
       * @param {"gemini-3.1-flash-lite" | "gemini-3.5-flash" | "gemini-3.5-flash-lite" | "gemini-3.6" | "gemini-3.7" | "gemini-3.8" | "gpt-5.6-sol" | "gpt-5.6-terra" | "gpt-5.6-luna"} [advancedParametersObject.model]
